...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post commentaries_url, params: { commentary: { cuerpo: @commentary.cuerpo, publication_id: @commentary.publication_id, user_id: @commentary.user_id } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { cuerpo: @commentary.cuerpo, publication_id: @commentary.publication_id, user_id: @commentary.user_id } }
