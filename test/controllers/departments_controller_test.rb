...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { country_id: @department.country_id, nombre: @department.nombre } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { country_id: @department.country_id, nombre: @department.nombre } }
